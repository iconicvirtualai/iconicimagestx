  ...
  return (
    <section className="relative overflow-hidden bg-transparent pt-20 pb-4">
      <div className="container mx-auto px-4 text-center">
        ...
        {/* Headline */}
        <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-4 leading-[1.05] tracking-tight text-white max-w-4xl mx-auto animate-in fade-in slide-in-from-bottom-4 duration-700 whitespace-pre-line">
          Create <span className="text-white">Stunning</span> Property <br />
          Media <span className="text-teal-400">Instantly</span> with AI
        </h1>

        {/* Subheadline */}
        <p className="text-base md:text-lg text-gray-400 mb-6 max-w-xl mx-auto leading-relaxed animate-in fade-in slide-in-from-bottom-6 duration-900 font-medium">
        ...
        {/* Social Proof */}
        <div className="flex flex-col items-center gap-3 mb-10 animate-in fade-in slide-in-from-bottom-10 duration-1100">
        ...
        <div className="flex items-center justify-center gap-3 text-[10px] md:text-xs font-bold uppercase tracking-[0.3em] text-gray-500 mb-2">
          <span>Before</span>
